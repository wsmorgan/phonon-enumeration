...
def polya(concentrations, group, arrowings=None, debug=True):
    ...
    polyndict = {}
    print('g1',_group_to_cyclic(group))
    ...
    print([p.coeff() for p in polyndict.values()])
    print('rad',rad)
    print('g',len(group))
